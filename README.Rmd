...
## Goal
*serotrackr* is an R package that facilitates submissions to SeroTracker.  
...
## Get started
[This vignette](https://serotracker.github.io/serotrackr/articles/serotrackr.html) guides you through the best practices of using *serotrackr*.
